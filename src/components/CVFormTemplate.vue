        ...
        <section class="first-step">
            <aside class="aside">
                <div class="upload-image-wrapper">
                    ...
                    <label class="upload-image" for="upload-photo" :style="'background-image:url(' + source + ');'">
                        <svg v-if="!source" xmlns="http://www.w3.org/2000/svg" width="40" viewBox="0 0 24 24"><path fill="#222" d="M19 13a1 1 0 0 0-1 1v.38l-1.48-1.48a2.79 2.79 0 0 0-3.93 0l-.7.7-2.48-2.48a2.85 2.85 0 0 0-3.93 0L4 12.6V7a1 1 0 0 1 1-1h7a1 1 0 0 0 0-2H5a3 3 0 0 0-3 3v12a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3v-5a1 1 0 0 0-1-1ZM5 20a1 1 0 0 1-1-1v-3.57l2.9-2.9a.79.79 0 0 1 1.09 0l3.17 3.17 4.3 4.3Zm13-1a.89.89 0 0 1-.18.53L13.31 15l.7-.7a.77.77 0 0 1 1.1 0L18 17.21Zm4.71-14.71-3-3a1 1 0 0 0-.33-.21 1 1 0 0 0-.76 0 1 1 0 0 0-.33.21l-3 3a1 1 0 0 0 1.42 1.42L18 4.41V10a1 1 0 0 0 2 0V4.41l1.29 1.3a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42Z"/></svg>
                    </label>
                </div>

                <input type="text" id="name" name="name" class="form-control form-control-sm mb-2" placeholder="Full Name" v-model="userName">
                <input type="text" id="name" name="name" class="form-control form-control-sm mb-5" placeholder="Position" v-model="position">
                ...
                <ul class="list-unstyled">
                    <li class="d-flex align-items-center mb-2">
                        ...
                        <input type="text" id="name" name="name" class="form-control form-control-sm" placeholder="Phone" v-model="phone">
                    </li>
                    <li class="d-flex align-items-center mb-2">
                        ...
                        <input type="text" id="name" name="name" class="form-control form-control-sm" placeholder="Email" v-model="email">
                    </li>
                    <li class="d-flex align-items-center mb-2">
                        ...
                        <input type="text" id="name" name="name" class="form-control form-control-sm" placeholder="Website" v-model="website">
                    </li>
                    <li class="d-flex align-items-center mb-5">
                        ...
                        <input type="text" id="name" name="name" class="form-control form-control-sm" placeholder="Location" v-model="location">
                    </li>
                </ul>

                <div class="d-flex align-items-center justify-content-between mb-2">
                    <h3 class="mb-0"><strong>PROFESSIONAL SKILLS</strong></h3>
                    <input type="text" class="form-control form-control-sm w-50 mb-0" placeholder="Search skills..." v-model="searchSkills">
                </div>
                <ul class="list-unstyled skills-list">
                    <li v-for="(skill, index) in skillsList" :key="index">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" :id="skill.name" :checked="userSkills?.find(e => e.name === skill.name)" @change="updateSkills(skill)" :value="skill.name"/>
            ...
            <article class="content">
                ...
                <div class="current-position d-flex mb-3 gap-2">
                    <input type="text" placeholder="Position in BWL" class="form-control form-control-sm w-50" v-model="positionInBWL">
                    <input type="text" placeholder="From - Present" class="form-control form-control-sm w-50" v-model="time">
                </div>

                <div class="d-flex justify-content-end mb-2">
                    <input type="text" class="form-control form-control-sm mb-0 w-50" placeholder="Search projects..." v-model="searchProjects">
                </div>
                ...
                <div class="previous-jobs">
                    ...
                    <ul class="list-unstyled" v-if="jobs?.length">
                        <li v-for="(job,index) in jobs" :key="index" class="d-flex gap-3">
                ...
                <div class="education">
                    ...
                    <ul class="list-unstyled" v-if="education?.length">
                        <li v-for="(edu,index) in education" :key="index" class="d-flex gap-3">
    ...
    export default {
        ...
        methods: {
            ...
            filterSkills(query) {
                ...
                this.skillsList = this.skillsList.filter(i => i.name.toLowerCase().includes(searchQuery));
            },
            ...
            filterProjects(query) {
                ...
                const searchQuery = query
                this.projectsList = this.projectsList.filter(i => i.name.toLowerCase().includes(searchQuery));
            },
            ...
            updateSkills(skills) {
                if(this.userSkills.find(e => e.id === skills.id)) {
                    return this.userSkills = [
                        ...this.userSkills.filter(e => e.id !== skills.id)
                    ]
                }
                this.userSkills = [
                    ...this.userSkills,
        ...
        created() {
            this.skillsList = this.skills
            this.projectsList = this.projects
            // this.source = this.dataUser.source
            this.userName = this.dataUser.userName
            this.position = this.dataUser.position
            this.phone = this.dataUser.phone
            this.email = this.dataUser.email
            this.website = this.dataUser.website
            this.location = this.dataUser.location
            this.positionInBWL = this.dataUser.positionInBWL
            this.time = this.dataUser.time
        },

        mounted() {
            this.userProjects = this.projects.filter(e => this.dataUser?.projects?.includes(e.name))
            this.userSkills = this.skills.filter(e => this.dataUser?.skills?.includes(e.name))
            this.jobs = this.dataUser.jobs
            this.education = this.dataUser.education
        }
    }
</script>
